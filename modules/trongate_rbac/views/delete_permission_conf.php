...
<p>Are you sure you want to delete the permission <strong>"<?= out($record->name) ?>"</strong>?</p>
<p style="color:#dc2626">This will remove this permission from all roles.</p>
