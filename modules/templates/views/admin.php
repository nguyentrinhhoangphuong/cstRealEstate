...
?>
    <nav aria-label="Main navigation">
        <ul class="side-nav-menu">
            <li>
                <a href="dashboard/index"<?= $current_module === 'dashboard' ? ' class="active"' : '' ?>>
                    Dashboard
                </a>
            </li>
            ...
            <li>
                <a href="media/manage"<?= $current_module === 'media' ? ' class="active"' : '' ?>>
                    Media Library
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="trongate_administrators/manage"<?= $current_module === 'trongate_administrators' ? ' class="active"' : '' ?>>
                    Manage Users
                </a>
            </li>
        </ul>
...
<footer>
    <div class="footer-lg">
        <div class="footer-left">
            ...
            <a href="https://trongate.io/" target="_blank">Powered by Me</a>
        </div>
    ...
    <div class="footer-sm">
        ...
        <div class="footer-sm-links">
            ...
            <!-- <a href="https://trongate.io/documentation" target="_blank">Documentation</a> -->
            <span class="separator">|</span>
            <!-- <a href="https://github.com/trongate/trongate-framework" targets="_blank">GitHub</a> -->
        </div>
    </div>
</footer>
...
<nav class="slide-nav" id="slide-nav" aria-label="Navigation menu">
  ...
  <ul class="slide-nav-list">
    ...
    <li><a href="trongate_rbac/manage_roles">Access Control</a></li>
